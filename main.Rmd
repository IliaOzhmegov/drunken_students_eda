...
```{r, fig.cap = "Figure 1: Comparison of alcohol consumption during weekend and weekday"}
...
```{r, fig.cap = "Figure 7: Weekday alcohol consumption per Age and Gender"}
{
...
```{r, fig.cap = "Figure 8: Weekend alcohol consumption per Age and Gender"}
{
...
```{r, fig.cap = "Figure 9: Weekday alcohol consumption depending on the Area"}
{
...
```{r, fig.cap = "Figure 10: Alcohol consumption per students' family size"}
{
...
```{r, fig.cap = "Figure 11: Alcohol consumption depending on students' free time and go out time"}
{
...
```{r, fig.cap = "Figure 12: Alcohol consumption depending on students' free time and go out time"}
{
...
```{r, fig.cap = "Figure 13: Grades by gender and weekday alcohol consumption"}
{
...
```{r, fig.cap = "Figure 14: Grades by gender and weekend alcohol consumption"}
{
